...
export default function ManageRetailerFormEdit() {
    ...
    const handleSubmit = async(e) =>{
      ...
      if(retailerName =="" || ownerName =="" || retailerCode =="" || username =="" || password ==""){
        setOpen(true)
        setError(true)
  ...
  return (
    <main className="main-panel">
        ...
        <div className="top-heading-title">
            <strong>Edit Retailer Profile Photo</strong>
            </div> 
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <div className="searchinput-inner col">
                        ...
                        <input type="email" className="searchinput" value={email} onChange={(e) => setEmail(e.target.value.toUpperCase())}/>
                    </div>
                    <div className="searchinput-inner col">
                        <label>Password <span className="red-required">*</span></label> 
                        <input type="password" className="searchinput" value={password} onChange={(e) => setPassword(e.target.value)}/>
                    </div>
                    <div className="searchinput-inner col">
                        <label>Address</label>
