...
export default function CustomerOrders() {
  ...
  const handleOrderTypeChange = async (e, type) => {
    if(type == 'normal'){
      setOrderType("normal")
      fetchOrders()
    }else if(type == 'group'){
    ...
    <main className="main-panel">
      <div className="content-wrapper">
        ...
        <div className="order-table manage-page">
          ...
          <Chip label="Normal" className={orderType == "normal" ? "active" : "inActive"} data-name={"normal"} value={"normal"} onClick={(e) => handleOrderTypeChange(e, 'normal')} />
         
          <Chip label="Group" className={orderType == "group" ? "active" : "inActive"} data-name={"group"} value={"group"} onClick={(e) => handleOrderTypeChange(e, 'group')} />
