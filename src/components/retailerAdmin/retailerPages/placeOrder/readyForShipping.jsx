...
export default function ReadyForShippingGroupOrder() {
    ...
    const [statusName, setStatusname] = useState("Shipment");
        ...
        <main className="main-panel">
            <div className="content-wrapper pd-1r">
                <div className="dashboard-top-icon">
                    <Link to="/retailer/newCustomer" className="actives"> <PersonAddAltIcon /> Add New Customer </Link>
                    <Link to=""> <LocationSearchingIcon /> Place Order </Link>
                    <Link to=""> <SettingsIcon /> Manage Order </Link>
                </div>
            </div>
            ...
            <div className="content-wrapper mt-3 pd-1r">
                <div className="topNav">
                    ...
                    <Link to="/retailer/readyForShippingGroupOrder" className="active"> Ready For Shipping </Link>
