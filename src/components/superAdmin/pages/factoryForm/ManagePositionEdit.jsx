...
export default function ManagePositionEdit() {
  ...
  useEffect(() => {
    ...
    const fetchPosition = async () => {
      const res = await axiosInstance.post(`/position/fetch/${positionId}`, {
        token: user.data.token,
      });
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group row">
                ...
                <div className="col-md-4" style={{ padding: "0 15px" }}>
                  <div className="searchinput-inner">
                    <p>
                      Position Name <span className="red-required">*</span>
                    </p>
                    <input
                      className="searchinput"
                      type="text"
                ...
                <div className="col-md-4" style={{ padding: "0 15px" }}>
                  <div className="searchinput-inner">
                    <p>
                      Thai Position Name <span className="red-required">*</span>
                    </p>
                    <input
                      className="searchinput"
                      type="text"
